                                  ...
                                  return Row(mainAxisAlignment: MainAxisAlignment.end,
                                      children: [
                                        InkWell(onTap:(){
                                          ...
                                          callNext(context, CarDetails(from: from,Brandid:Brandid));
                                        },
      ...
      floatingActionButton: Consumer<MainProvider>(
        builder: (context,val,child) {
          return FloatingActionButton(
              ...
              onPressed: (){
               val.ClearDetails();
                Navigator.push(context, MaterialPageRoute(builder: (context)=>CarDetails(from: from,Brandid: Brandid,)));
              });
        }
      ),
